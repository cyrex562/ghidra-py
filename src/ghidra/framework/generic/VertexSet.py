...
class VertexSet implements KeyIndexableSet<Vertex> {
	...
	void setFirstOutgoingEdge(Vertex v, Edge e) {
		try {
			...
			Msg.error(this, "No Value Exception in setFirstOutgoingEdge()" + "\tVertex: " +
				v.toString() + "\tEdge: " + e.toString(), exc);
		}
	}
	...
	void setLastOutgoingEdge(Vertex v, Edge e) {
		try {
			...
			Msg.error(this, "No Value Exception in setLastOutgoingEdge()" + "\tVertex: " +
				v.toString() + "\tEdge: " + e.toString(), exc);
		}
	}
	...
	void setFirstIncomingEdge(Vertex v, Edge e) {
		try {
			...
			Msg.error(this, "No Value Exception in setFirstIncomingEdge()" + "\tVertex: " +
				v.toString() + "\tEdge: " + e.toString(), exc);
		}
	...
	void setLastIncomingEdge(Vertex v, Edge e) {
		try {
			...
			Msg.error(this, "No Value Exception in setLastIncomingEdge()" + "\tVertex: " +
				v.toString() + "\tEdge: " + e.toString(), exc);
		}
	}
