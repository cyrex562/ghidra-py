 ...
 */
public class UnsignedLongConstraintEditorProvider implements EditorProvider<BigInteger> {

	@Override
	public ColumnConstraintEditor<BigInteger> getEditor(
			ColumnConstraint<BigInteger> columnConstraint,
			ColumnData<BigInteger> columnDataSource) {
		return new UnsignedLongConstraintEditor(columnConstraint);
	}
