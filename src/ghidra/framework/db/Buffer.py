...
class Buffer(ABC):
    ...
    # @abstractmethod
    # def get(self, offset: int, bytes: bytearray) -> None:
    #     pass
    ...
    @abstractmethod
    def get(self, offset: int, data: bytearray, dataOffset: int, length: int) -> None:
        pass
    ...
    # @abstractmethod
    # def get(self, offset: int, length: int) -> bytearray:
    #     pass
    ...
    #         throws IndexOutOfBoundsException, IOException;
    @abstractmethod
    def put(self, offset: int, data: bytearray, dataOffset: int, length: int) -> int:
        pass
    ...
    #  * underlying storage.
    #  */
    # public int putInt(int offset, int v) throws IndexOutOfBoundsException, IOException;a
    @abstractmethod
