 ...
 */
public class FridaAttachDeviceByIdCommand extends AbstractFridaCommand<Void> {

	private String key;

	public FridaAttachDeviceByIdCommand(FridaManagerImpl manager, String key) {
		super(manager);
		this.key = key;
	}
