...
public interface FridaModelTargetThreadContainer extends //
		FridaModelTargetEventScope, //
		FridaEventsListenerAdapter {

	public FridaModelTargetThread getTargetThread(FridaThread thread);
	...
	public void threadExited(FridaThread thread, FridaCause caus);
