...
public class FridaModelTargetSymbolLoadImpl extends FridaModelTargetObjectImpl
		implements FridaModelTargetMethod {

	protected final TargetParameterMap paramDescs;

	public FridaModelTargetSymbolLoadImpl(FridaModelTargetSymbolContainer modules) {
		super(modules.getModel(), modules, "load", "SymbolLoad");
	...
	public CompletableFuture<Object> invoke(Map<String, ?> arguments) {
		getManager().console("DebugSymbol.load(" + 
				"'" + arguments.get("Path") + "');");
