...
# /**
 * The event corresponding with FridaThread.eBroadcastBitSelectedFrameChanged
 */
public class FridaSelectedFrameChangedEvent extends AbstractFridaEvent<String> {
	 ...
	 */
	public FridaSelectedFrameChangedEvent(FridaThreadInfo info) {
