...
@TargetObjectSchemaInfo(
	name = "DeviceAttachByIdConnector",
	elements = {
...
public class FridaModelTargetDeviceAttachByIdConnectorImpl extends FridaModelTargetObjectImpl
	...
	public FridaModelTargetDeviceAttachByIdConnectorImpl(
	...
	protected Map<String, ParameterDescription<?>> computeParameters() {
		...
		ParameterDescription<String> param = ParameterDescription.create(String.class, "Id", true,
			"", "Id", "device id");
		map.put("Id", param);
		return map;
	}
	...
	public CompletableFuture<Void> launch(Map<String, ?> args) {
		...
		return AsyncUtils.sequence(TypeSpec.VOID).then(seq -> {
			getManager().attachDeviceById(idstr).handle(seq::nextIgnore);
