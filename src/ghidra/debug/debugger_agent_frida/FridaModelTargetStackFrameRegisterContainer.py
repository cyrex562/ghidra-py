...
@TargetObjectSchemaInfo(
	...
	attributes = {
		@TargetAttributeType(
			...
			type = FridaModelTargetStackFrameRegisterBank.class,
			required = true),
		@TargetAttributeType(
...
public interface FridaModelTargetStackFrameRegisterContainer
		extends FridaModelTargetRegisterContainer {

	public FridaModelTargetObject getTargetRegisterBank(FridaValue val);
