...
@TargetObjectSchemaInfo(
	name = "DeviceAttachByTypeConnector",
	elements = {
...
public class FridaModelTargetDeviceAttachByTypeConnectorImpl extends FridaModelTargetObjectImpl
	...
	public FridaModelTargetDeviceAttachByTypeConnectorImpl(
			FridaModelTargetConnectorContainerImpl connectors,
			String name) {
	...
	protected Map<String, ParameterDescription<?>> computeParameters() {
		...
		//ParameterDescription<String> param = ParameterDescription.create(String.class, "Type", true,
		//	"", "Type", "device type");
		...
		ParameterDescription<String> param = ParameterDescription.choices(String.class, "Type",
			choices, "Type", "device type");
		map.put("Type", param);
		return map;
	}
	...
	public CompletableFuture<Void> launch(Map<String, ?> args) {
		String idstr = (String) args.get("Type");
		return AsyncUtils.sequence(TypeSpec.VOID).then(seq -> {
			getManager().attachDeviceByType(idstr).handle(seq::nextIgnore);
