...
public interface FridaModelTargetSymbolContainer
		extends FridaModelTargetObject, TargetSymbolNamespace {

	public FridaModelTargetSymbolImpl getTargetSymbol(FridaSymbol symbol);
