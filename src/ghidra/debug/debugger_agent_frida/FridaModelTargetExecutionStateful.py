 ...
 */
public interface FridaModelTargetExecutionStateful
		extends FridaModelTargetObject, TargetExecutionStateful {
	...
	public default void setExecutionState(TargetExecutionState state, String reason) {
		...
		if (this instanceof FridaModelTargetAccessConditioned) {
			FridaModelTargetAccessConditioned conditioned = (FridaModelTargetAccessConditioned) this;
