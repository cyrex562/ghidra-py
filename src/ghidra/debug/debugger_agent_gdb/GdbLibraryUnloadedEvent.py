...
# /**
 * The event corresponding with "{@code =library-unloaded}"
 */
public class GdbLibraryUnloadedEvent extends AbstractGdbLibraryEvent {
	 ...
	 */
	public GdbLibraryUnloadedEvent(CharSequence tail) throws GdbParseError {
		super(tail);
	}
}
