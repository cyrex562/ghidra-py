...
# /**
 * The event corresponding with "{@code ^connected}"
 */
public class GdbCommandConnectedEvent extends AbstractGdbCompletedCommandEvent {
	 ...
	 */
	public GdbCommandConnectedEvent(CharSequence tail) throws GdbParseError {
		super(tail);
	}
}
