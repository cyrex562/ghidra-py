...
# /**
 * The event corresponding with "{@code ^exit}"
 */
public class GdbCommandExitEvent extends AbstractGdbCompletedCommandEvent {
	 ...
	 */
	public GdbCommandExitEvent(CharSequence tail) throws GdbParseError {
		super(tail);
	}
