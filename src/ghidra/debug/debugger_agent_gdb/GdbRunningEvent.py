 ...
 */
public class GdbRunningEvent extends AbstractGdbEventWithStateChange {
	 ...
	 */
	public GdbRunningEvent(CharSequence tail) throws GdbParseError {
		super(tail);
	}

	@Override
	public GdbState newState() {
		return GdbState.RUNNING;
	}

	/**
	 * Assume a thread ID is specified, and get that ID
	 * 
	 * @return the ID
	 */
	public String assumeThreadId() {
		return getInfo().getString("thread-id");
	}
}
