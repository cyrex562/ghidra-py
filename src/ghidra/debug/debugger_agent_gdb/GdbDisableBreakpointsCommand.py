 ...
 */
public class GdbDisableBreakpointsCommand extends AbstractGdbCommand<Void> {

	private final long[] numbers;

	public GdbDisableBreakpointsCommand(GdbManagerImpl manager, long... numbers) {
		super(manager);
	...
	public String encode() {
		return "-break-disable " + StringUtils.join(numbers, ' ');
	}
	...
	public Void complete(GdbPendingCommand<?> pending) {
		...
		for (long number : numbers) {
			manager.doBreakpointDisabled(number, pending);
		}
		return null;
	}
}
