...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeRemoved & WatchpointEventType.eWatchpointEventTypeRemoved
 */
public class LldbBreakpointDeletedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 * The breakpoint number must be specified by lldb.
	 * 
