...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeCommandChanged & WatchpointEventType.eWatchpointEventTypeCommandChanged
 */
public class LldbBreakpointCommandChangedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointCommandChangedEvent(DebugBreakpointInfo info) {
		super(info);
