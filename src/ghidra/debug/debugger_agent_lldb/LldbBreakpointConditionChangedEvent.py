...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeConditionChanged & WatchpointEventType.eWatchpointEventTypeConditionChanged
 */
public class LldbBreakpointConditionChangedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointConditionChangedEvent(DebugBreakpointInfo info) {
		super(info);
