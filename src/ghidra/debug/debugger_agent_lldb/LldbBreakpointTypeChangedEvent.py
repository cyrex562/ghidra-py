...
# /**
 * The event corresponding with WatchpointEventType.eWatchpointEventTypeTypeChanged
 */
public class LldbBreakpointTypeChangedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointTypeChangedEvent(DebugBreakpointInfo info) {
		super(info);
