...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeEnabled & WatchpointEventType.eWatchpointEventTypeEnabled
 */
public class LldbBreakpointEnabledEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointEnabledEvent(DebugBreakpointInfo info) {
		super(info);
