...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeIgnoreChanged & WatchpointEventType.eWatchpointEventTypeIgnoreChanged
 */
public class LldbBreakpointIgnoreChangedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointIgnoreChangedEvent(DebugBreakpointInfo info) {
		super(info);
