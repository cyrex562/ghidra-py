...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeLocationsRemoved
 */
public class LldbBreakpointLocationsRemovedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointLocationsRemovedEvent(DebugBreakpointInfo info) {
		super(info);
