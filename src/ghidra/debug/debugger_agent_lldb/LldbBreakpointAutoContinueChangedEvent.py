...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeAutoContinueChanged
 */
public class LldbBreakpointAutoContinueChangedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointAutoContinueChangedEvent(DebugBreakpointInfo info) {
		super(info);
