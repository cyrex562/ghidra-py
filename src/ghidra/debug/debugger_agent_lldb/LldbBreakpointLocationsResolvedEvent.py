...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeLocationsResolved
 */
public class LldbBreakpointLocationsResolvedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointLocationsResolvedEvent(DebugBreakpointInfo info) {
		super(info);
