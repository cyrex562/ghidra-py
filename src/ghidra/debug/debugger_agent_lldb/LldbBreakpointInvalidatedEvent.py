...
# /**
 * The event corresponding with BreakpointEventType.eBreakpointEventTypeInvalidType & WatchpointEventType.eWatchpointEventTypeInvalidType
 */
public class LldbBreakpointInvalidatedEvent extends AbstractLldbEvent<DebugBreakpointInfo> {
	 ...
	 * 
	 */
	public LldbBreakpointInvalidatedEvent(DebugBreakpointInfo info) {
		super(info);
