...
public class DbgModel {
	...
	private static HostDataModelAccess wrapClient(DebugClientInternal debugClient) {
		...
		HostDataModelAccess hostDataModelAccess =
			HostDataModelAccessInternal.tryPreferredInterfaces(jnaClient::QueryInterface);
		hostDataModelAccess.setClient(debugClient);
	...
	public static HostDataModelAccess debugConnect(String remoteOptions) {
		...
		return wrapClient(DebugClientInternal.tryPreferredInterfaces((refiid,
	...
	public static HostDataModelAccess debugCreate() {
		addSearchPaths();
		return wrapClient(
			DebugClientInternal.tryPreferredInterfaces(DbgEngNative.INSTANCE::DebugCreate));
	}
	...
	public static HostDataModelAccess debugCreate(int options) {
		...
		return wrapClient(DebugClientInternal.tryPreferredInterfaces(
