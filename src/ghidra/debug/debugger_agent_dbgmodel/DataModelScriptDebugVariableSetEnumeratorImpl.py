...
public class DataModelScriptDebugVariableSetEnumeratorImpl
		implements DataModelScriptDebugVariableSetEnumeratorInternal {
	@SuppressWarnings("unused")
	private final OpaqueCleanable cleanable;
	private final IDataModelScriptDebugVariableSetEnumerator jnaData;

	public DataModelScriptDebugVariableSetEnumeratorImpl(
			IDataModelScriptDebugVariableSetEnumerator jnaData) {
