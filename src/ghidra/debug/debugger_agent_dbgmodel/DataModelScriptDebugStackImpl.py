...
public class DataModelScriptDebugStackImpl implements DataModelScriptDebugStackInternal {
	@SuppressWarnings("unused")
	private final OpaqueCleanable cleanable;
	private final IDataModelScriptDebugStack jnaData;

	public DataModelScriptDebugStackImpl(IDataModelScriptDebugStack jnaData) {
