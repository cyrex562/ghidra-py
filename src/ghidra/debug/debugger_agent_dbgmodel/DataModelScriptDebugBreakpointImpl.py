...
public class DataModelScriptDebugBreakpointImpl implements DataModelScriptDebugBreakpointInternal {
	@SuppressWarnings("unused")
	private final OpaqueCleanable cleanable;
	private final IDataModelScriptDebugBreakpoint jnaData;

	public DataModelScriptDebugBreakpointImpl(IDataModelScriptDebugBreakpoint jnaData) {
