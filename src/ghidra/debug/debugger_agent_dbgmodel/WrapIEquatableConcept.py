...
public class WrapIEquatableConcept extends UnknownWithUtils implements IEquatableConcept {
	...
	public WrapIEquatableConcept(Pointer pvInstance) {
		super(pvInstance);
	}

	@Override
	public HRESULT AreObjectsEqual(Pointer contextObject, Pointer otherObject,
			BOOLByReference isEqual) {
		return _invokeHR(VTIndices.ARE_OBJECTS_EQUAL, getPointer(), contextObject, otherObject,
			isEqual);
	}
