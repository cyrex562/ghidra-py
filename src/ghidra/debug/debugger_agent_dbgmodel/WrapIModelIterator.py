...
public class WrapIModelIterator extends UnknownWithUtils implements IModelIterator {
	...
	public WrapIModelIterator(Pointer pvInstance) {
		super(pvInstance);
	}
	...
	@Override
	public HRESULT GetNext(PointerByReference object, ULONGLONG dimensions,
			PointerByReference indexers,
			PointerByReference metadata) {
		return _invokeHR(VTIndices.GET_NEXT, getPointer(), object, dimensions, indexers, metadata);
	}
