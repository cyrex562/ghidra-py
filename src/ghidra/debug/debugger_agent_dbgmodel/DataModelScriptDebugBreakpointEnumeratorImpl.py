...
public class DataModelScriptDebugBreakpointEnumeratorImpl
		implements DataModelScriptDebugBreakpointEnumeratorInternal {
	@SuppressWarnings("unused")
	private final OpaqueCleanable cleanable;
	private final IDataModelScriptDebugBreakpointEnumerator jnaData;

	public DataModelScriptDebugBreakpointEnumeratorImpl(
			IDataModelScriptDebugBreakpointEnumerator jnaData) {
