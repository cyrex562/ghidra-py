...
public class DataModelScriptDebugImpl implements DataModelScriptDebugInternal {
	@SuppressWarnings("unused")
	private final OpaqueCleanable cleanable;
	private final IDataModelScriptDebug jnaData;

	public DataModelScriptDebugImpl(IDataModelScriptDebug jnaData) {
