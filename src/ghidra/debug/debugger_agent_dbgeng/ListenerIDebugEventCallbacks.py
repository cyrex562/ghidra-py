...
public class ListenerIDebugEventCallbacks extends Structure
		implements IDebugEventCallbacks, MarkerEventCallbacks {
	public static final List<String> FIELDS = createFieldsOrder("vtbl");

	public ListenerIDebugEventCallbacks(CallbackIDebugEventCallbacks callback) {
		this.vtbl = this.constructVTable();
		this.initVTable(callback);
		super.write();
	}

	public VTableIDebugEventCallbacks.ByReference vtbl;
	...
	protected void initVTable(final CallbackIDebugEventCallbacks callback) {
