...
public class WrapIDebugControl6 extends WrapIDebugControl5 implements IDebugControl6 {
	...
	public WrapIDebugControl6(Pointer pvInstance) {
		super(pvInstance);
	}

	@Override
	public HRESULT GetExecutionStatusEx(ULONGByReference Status) {
		return _invokeHR(VTIndices6.GET_EXECUTABLE_STATUS_EX, getPointer(), Status);
	}
}
