...
public class SBWatchpoint {
  ...
  protected static long swigRelease(SBWatchpoint obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void Clear() {
    lldbJNI.SBWatchpoint_Clear(swigCPtr, this);
  }
  ...
  public SBType GetType() {
    return new SBType(lldbJNI.SBWatchpoint_GetType(swigCPtr, this), true);
  }

  public WatchpointValueKind GetWatchValueKind() {
    return WatchpointValueKind.swigToEnum(lldbJNI.SBWatchpoint_GetWatchValueKind(swigCPtr, this));
  }

  public String GetWatchSpec() {
    return lldbJNI.SBWatchpoint_GetWatchSpec(swigCPtr, this);
  }

  public boolean IsWatchingReads() {
    return lldbJNI.SBWatchpoint_IsWatchingReads(swigCPtr, this);
  }

  public boolean IsWatchingWrites() {
    return lldbJNI.SBWatchpoint_IsWatchingWrites(swigCPtr, this);
  }
