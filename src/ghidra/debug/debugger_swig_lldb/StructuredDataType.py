...
public final class StructuredDataType {
  ...
  public final static StructuredDataType eStructuredDataTypeSignedInteger = new StructuredDataType("eStructuredDataTypeSignedInteger");
  public final static StructuredDataType eStructuredDataTypeUnsignedInteger = new StructuredDataType("eStructuredDataTypeUnsignedInteger", lldbJNI.eStructuredDataTypeUnsignedInteger_get());
  ...
  private static StructuredDataType[] swigValues = { eStructuredDataTypeInvalid, eStructuredDataTypeNull, eStructuredDataTypeGeneric, eStructuredDataTypeArray, eStructuredDataTypeInteger, eStructuredDataTypeFloat, eStructuredDataTypeBoolean, eStructuredDataTypeString, eStructuredDataTypeDictionary, eStructuredDataTypeSignedInteger, eStructuredDataTypeUnsignedInteger };
