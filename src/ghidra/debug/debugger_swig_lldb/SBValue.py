...
public class SBValue {
  ...
  protected static long swigRelease(SBValue obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SBWatchpoint Watch(boolean resolve_location, boolean read, boolean write, SBError error) {
    return new SBWatchpoint(lldbJNI.SBValue_Watch__SWIG_0(swigCPtr, this, resolve_location, read, write, SBError.getCPtr(error), error), true);
  }

  public SBWatchpoint Watch(boolean resolve_location, boolean read, boolean write) {
    return new SBWatchpoint(lldbJNI.SBValue_Watch__SWIG_1(swigCPtr, this, resolve_location, read, write), true);
  }
