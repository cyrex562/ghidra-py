...
public class FunctionSignatureDecompilerHoverPlugin extends Plugin {
	...
	private FunctionSignatureDecompilerHover functionNameHoverService;

	public FunctionSignatureDecompilerHoverPlugin(PluginTool tool) {
		super(tool);
		functionNameHoverService = new FunctionSignatureDecompilerHover(tool);
		registerServiceProvided(DecompilerHoverService.class, functionNameHoverService);
	}
