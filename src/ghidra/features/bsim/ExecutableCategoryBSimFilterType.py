...
public class ExecutableCategoryBSimFilterType extends BSimFilterType {
	...
	private String subType; // The specific executable category this element filters on
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ExecutableCategoryBSimFilterType t) {
	...
	public String buildSQLCombinedClause(List<String> subClauses) {
		StringBuilder buf = new StringBuilder();
		buf.append(
			"EXISTS ( SELECT 1 FROM execattable WHERE desctable.id_exe=execattable.id_exe AND (");
