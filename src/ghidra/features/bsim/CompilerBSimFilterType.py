 ...
 */
public class CompilerBSimFilterType extends BSimFilterType {
	public static final String XML_VALUE = "compequals";

	public CompilerBSimFilterType() {
		super("Compiler equals", XML_VALUE, "gcc");
	}
