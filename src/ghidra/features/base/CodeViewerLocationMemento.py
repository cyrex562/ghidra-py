...
public class CodeViewerLocationMemento extends LocationMemento {
	...
	public CodeViewerLocationMemento(Program program, ProgramLocation location,
			int cursorOffset) {
	...
	public CodeViewerLocationMemento(SaveState saveState, Program[] programs) {
		...
		cursorOffset = saveState.getInt("CURSOR_OFFSET", 0);
	}
	...
	public void saveState(SaveState saveState) {
		...
		saveState.putInt("CURSOR_OFFSET", cursorOffset);
	}
