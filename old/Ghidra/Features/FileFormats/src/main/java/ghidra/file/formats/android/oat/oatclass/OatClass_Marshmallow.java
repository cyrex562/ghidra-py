...
public class OatClass_Marshmallow extends OatClass_Lollipop {
	...
	OatClass_Marshmallow(BinaryReader reader, ClassDataItem classDataItem, String oatVersion)
			throws IOException {
	...
	public DataType toDataType() throws DuplicateNameException, IOException {
		...
		try {
			renameDataType(dataType, OatClass_Marshmallow.class.getSimpleName());
		}
		catch (Exception e) {
			//ignore...
		}
