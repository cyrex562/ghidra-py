...
public class TypeLookupTable_Pie extends TypeLookupTable {
	...
	public TypeLookupTable_Pie(BinaryReader reader) throws IOException {
		dex_data_begin_ = reader.readNextInt();
	...
	public DataType toDataType() throws DuplicateNameException, IOException {
		Structure structure = new StructureDataType(
			TypeLookupTable_Pie.class.getSimpleName() + "_" + entryList.size(), 0);
		structure.add(DWORD, "dex_data_begin_", null);
