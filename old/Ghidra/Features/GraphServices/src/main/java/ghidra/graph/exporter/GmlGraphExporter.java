...
public class GmlGraphExporter extends AbstractAttributedGraphExporter {

	@Override
	public void exportGraph(AttributedGraph graph, File file) throws IOException {
		GmlExporter<AttributedVertex, AttributedEdge> exporter =
			new GmlExporter<>(vertexIdProvider);
